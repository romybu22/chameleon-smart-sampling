...
def save_rows_to_tf_record_file(rows, make_sequence_example_fn, sessions_df_length, export_filename,
                                content_article_embeddings=None, num_of_articles_in_sub_group=None):
    ...
    try:
        ...
        for row in rows:
            ...
            seq_example = make_sequence_example_fn(row, num_of_articles_in_sub_group, content_article_embeddings)
